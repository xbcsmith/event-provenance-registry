...
func (r *QueryResolver) EventReceivers(
	args struct{ EventReceiver FindEventReceiverInput },
...
func (r *QueryResolver) EventReceiverGroups(
	args struct{ EventReceiverGroup FindEventReceiverGroupInput },
) ([]storage.EventReceiverGroup, error) {
	groups, err := storage.FindEventReceiverGroup(
		r.Connection.Client,
		args.EventReceiverGroup.toMap(),
	)
...
func (r *QueryResolver) EventReceiversByID(
...
func (r *QueryResolver) EventReceiverGroupsByID(
	args struct{ ID graphql.ID },
) ([]storage.EventReceiverGroup, error) {
